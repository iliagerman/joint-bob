...
const requestUnsignedSchema = z.object({ invitationId: uuid, clusterId: uuid, requestId: uuid, member: nodeSchema }).strict();
...
export function redeemMembershipInvitation(
  ...
  return transaction(db, () => {
    ...
    const unsigned = requestUnsignedSchema.parse({ invitationId: request.invitationId, clusterId: request.clusterId, requestId: request.requestId, member: request.member });
