...
async function mutate(command: Exclude<BrowserMonitorCommand, { action: "list" | "checkers" | "installChecker" | "create" | "history" | "preview" }>, current: MonitorRecord): Promise<unknown> {
